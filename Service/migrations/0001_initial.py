    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_total', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Total de Produtos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Service.service', verbose_name='Produto')),
