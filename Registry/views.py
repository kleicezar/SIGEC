...
def Client_Create(request):
    ...
    if request.method == "POST":
        ...
        if form_address.is_valid() and form_Person.is_valid():
            ...
            if form_fisicPerson.is_valid():
                ...
                if person.email and person.password: 
                    person.id_user_fk = u
                    u = createUser(person.content_object.name, person.email, person.password)
            ...
            if form_legalPerson.is_valid():
                ...
                if person.email and person.password: 
                    u = createUser(person.content_object.fantasyName, person.email, person.password)
                    person.id_user_fk = u
                    person.save()
            ...
            if form_foreigner.is_valid():
                ...
                if person.email and person.password: 
                    create = createUser(person.content_object.name_foreigner, person.email, person.password,)
