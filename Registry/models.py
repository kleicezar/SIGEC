...
class Person(models.Model):
    ...
    isClient = models.BooleanField("Cliente")
    isSupllier = models.BooleanField("Fornecedor")
    isUser = models.BooleanField("Usuario do Sistema")
    isEmployee = models.BooleanField("Funcionario")
    isSalesman = models.BooleanField("Vendedor")
    isFormer_employee = models.BooleanField("Ex-Funcionario")
    isCarrier = models.BooleanField("Transportadora")
    isDelivery_man = models.BooleanField("Entregador")
    isTechnician = models.BooleanField("Tecnico")
