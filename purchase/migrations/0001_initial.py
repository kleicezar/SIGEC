    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observation_tax', models.TextField(null=True, verbose_name='Observação sobre Imposto')),
                ('freight_type', models.CharField(choices=[('fob', 'fob'), ('cif', 'cif')], max_length=3)),
                ('freight_value', models.IntegerField(null=True, verbose_name='Valor do Frete')),
                ('observation_freight', models.TextField(null=True, verbose_name='Observação sobre Frete')),
                ('observation_picking_list', models.TextField(null=True, verbose_name='Observação sobre Romaneio')),
